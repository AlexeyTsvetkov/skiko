...
val compileWasm = tasks.register<CompileCppTask>("compileWasm") {
...
fun registerNativeBridgesTask(os: OS, arch: Arch): TaskProvider<CompileCppTask> {
    return tasks.register<CompileCppTask>("${os.id}_${arch.id}_CrossCompile") {
...
val compileJvmBindings = tasks.register<CompileCppTask>("compileJvmBindings") {
...
val linkJvmBindings = tasks.register<LinkSharedLibraryTask>("linkJvmBindings") {
